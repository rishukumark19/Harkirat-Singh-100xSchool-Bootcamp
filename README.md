...
Welcome to my learning logs for the **100xDevs Bootcamp**. This repository is a living document of my evolution from basic web components to complex full-stack systems.
...
- **Web Development Warmup**
  ...
  - [Zerodha Clone (Ugly vs Nice)](./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/)
  - [VS-Code Landing Page](./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-and-Css-Vs-code/)
- **JavaScript Prerequisites**
  - [JS Foundations](./Week 0 Prerequisites/002-JavaScript/001-JsFoundations.js)
  - [JS Foundation Offline](./Week 0 Prerequisites/002-JavaScript/001-JsFundation-offline.js)
  - [JS APIs & Methods](./Week 0 Prerequisites/002-JavaScript/002-Basics-JS-APIS.js)

### 🌊 Week 1: Advanced Layouts & UI

- **HTML/CSS Class**
  - [ElevenLabs Landing Page](./Week 1/html-class/elevenlabs/)
  - [Generic HTML Practice](./Week 1/html-class/index.html)
...
### 🔹 Zerodha Clone Evolution

> From raw HTML structure to a polished CSS Flexbox layout.

#### ✨ Final Polished Version

<img src="./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/nice-zerodha.png" width="100%" alt="Zerodha Nice Preview">

#### 🛠️ Comparative View

<img src="./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/ugly-zerodha.png" width="100%" alt="Zerodha Ugly Preview">

**🔗 Quick Links:**

- [🌟 Nice Version (Code)](./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/nice-zerodha.html)
- [🏗️ Ugly Version (Code)](./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/ugly-zerodha.html)
- [📝 HTML/CSS Notes](./Week 0 Prerequisites/001-Web-Dev-Warmup/Html-Css-basics-simple-zerodha-app/html-css-learning-notes.md)
